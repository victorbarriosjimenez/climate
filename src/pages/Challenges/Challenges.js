    ...
    return (
        <>
            ...
            <div className="container">
                ...
                <p>
                    De acuerdo con el Foro Económico Mundial, asegurar un futuro más
                    resiliente debe ser nuestra prioridad ya que el cambio climático
                    es el desafío más grande al que se enfrenta la humanidad y esta
                    década será un momento decisivo para la acción climática. Este
                    mismo informe, señala que los riesgos ambientales y climáticos,
                    como los desastres naturales y la falta de adaptación al cambio
                    climático, son algunas de las mayores amenazas para la
                    estabilidad económica y social de América Latina.
                </p>
                ...
                <ul>
                    <li>
                        ...
                        puedan ser consideradas bajas en carbono. Todos reciben y
                        gastan más dinero en industrias no sostenibles que en
                    ...
                    <li>
                        Los presupuestos asignados a la explotación de hidrocarburos
                        sobrepasan por 39 veces a los presupuestos etiquetados para
                        la eficiencia energética, las energías renovables y la
                    ...
                    <li>
                        Ecuador, México y Trinidad y Tobago son los países con los
                        niveles más altos de ingresos intensivos en carbono,
                        integrados por hidrocarburos, minería y combustibles.
                    </li>
                    <li>
                        Bolivia y México son los países con los mayores niveles de
                        presupuestos asignados a la explotación de hidrocarburos.
                    </li>
                    <li>
                ...
                <Typography variant="h2" as="h2">
                    LA IMPORTANCIA DE LA COOPERACIÓN REGIONAL E INTERNACIONAL EN LA
